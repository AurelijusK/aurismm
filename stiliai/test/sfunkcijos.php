...
function lentele_c( $pavadinimas, $tekstas, $n_nuoroda, $kom_kiekis = FALSE, $datai = FALSE, $autorius = FALSE, $reitingai = FALSE ) {
	...
	?>
			...
			<!-- SELECT * FROM `jk_naujienos` -->

			 
            <div class="col-12 col-md-6  one portfolio-item" >
			<!-- <div class="box-image-container" style="background-image: url(images/portfolio-3.jpg);"></div>   -->
                <div class="portfolio-content" >
                    <a href="<?php echo $n_nuoroda; ?>" class="port-link white-text" style ><?php echo $pavadinimas; ?></a>
                    </br></br>
                    <a class="text-link"><?php echo $tekstas; ?></a>
...
?>
	...
	<section>
			 ...
			 <div class="col-12 col-md-6 four portfolio-item">
                <div class="portfolio-content">
                    <a  class="port-link" ><?php echo $pavadinimas; ?></a>
                    </br></br>
                    <a class="text-link"><?php echo $tekstas; ?></a>
